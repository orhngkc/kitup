<?php
	$sales = $pdo->query("SELECT * FROM books where on_sale = 1 && code = 1 ORDER BY created_at DESC LIMIT 0,6");
	$sale = $sales->fetchAll();
?>
<section id="content">
			<div class="content-wrap p-0">
				<div class="section border-0 bg-transparent mb-1">
					<div class="container">
						...
						<div class="row d-flex justify-content-center" id="cont">
